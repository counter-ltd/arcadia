    ...
    static func loadNavigationRegistry() -> NavigationRegistry {
        let fallback = NavigationRegistry(
            pages: [
                ...
                PageDefinition(id: "late.settings", title: "Late.sh", description: "Configure Late.sh server URL, credentials, and connection preferences.", glyph: "ST", systemImage: "gearshape", accent: "violet", requiredModule: ModuleNames.late)
            ],
            groups: [
            ...
            settingsHubPages: ["global.logs", "global.modules", "global.settings", "late.settings"],
