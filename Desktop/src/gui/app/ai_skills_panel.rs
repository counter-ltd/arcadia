...
impl ArcadiaRoot {
    pub fn ai_skills_panel(
        ...
        let active_ids = self.ai.active_skill_ids.clone();
                        ...
                        div()
                            ...
                            .on_mouse_down(
                                ...
                                cx.listener(move |this, _, _, cx| {
                                    if this.ai.active_skill_ids.contains(&skill_id_toggle) {
                                        this.ai.active_skill_ids
                                            .retain(|id| id != &skill_id_toggle);
                                    } else {
                                        this.ai.active_skill_ids.push(skill_id_toggle.clone());
                                    }
                                    cx.notify();
                                }),
                            ),
