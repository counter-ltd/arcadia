...
pub const NAME: &str = "ai-provider-llama-cpp";
...
#[derive(Default)]
pub struct LlamaCppExtension;

impl Extension for LlamaCppExtension {
    fn manifest(&self) -> OwnedModuleManifest {
        OwnedModuleManifest {
            name: NAME.to_string(),
            glyph: "llama-cpp".to_string(),
...
crate::register_extension!(LlamaCppExtension);
